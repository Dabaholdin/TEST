...
const ProviderForm: React.FC<{
    ...
    const [catalogsArr] = useState<Array<{ label: string, value: number }>>(() => {
    ...
    const providerFormSubmitHandler = handleSubmit((formValues: ICreateProviderData) => {
        formValues.catalogs = activeCatalogsArr.reduce((result, catalog) => [...result, catalog.value], [])
