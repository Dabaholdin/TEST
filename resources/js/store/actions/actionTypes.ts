...
export const FETCH_OZON_GOODS_STOCKS_START = 'FETCH_OZON_GOODS_STOCKS_START'
export const FETCH_OZON_GOODS_STOCKS_SUCCESS = 'FETCH_OZON_GOODS_STOCKS_SUCCESS'
export const FETCH_OZON_GOODS_STOCKS_ERROR = 'FETCH_OZON_GOODS_STOCKS_ERROR'

export const FETCH_OZON_ORDERS_START = 'FETCH_OZON_ORDERS_START'
export const FETCH_OZON_ORDERS_SUCCESS = 'FETCH_OZON_ORDERS_SUCCESS'
export const FETCH_OZON_ORDERS_ERROR = 'FETCH_OZON_ORDERS_ERROR'
...
export const ADD_TO_ORDER_PRODUCTS = 'ADD_TO_ORDER_PRODUCTS'
...
export const CHECK_BAIKAL_STATUS = 'CHECK_BAIKAL_STATUS'
export const DELETE_BAIKAL_ID = 'DELETE_BAIKAL_ID'

export const EDIT_ORDER_ADMIN = 'EDIT_ORDER_ADMIN'
...
export const EDIT_CONTAINER_ADMIN = 'EDIT_CONTAINER_ADMIN'
...
export const UPDATE_CATALOG_FILE = 'UPDATE_CATALOG_FILE'
...
// CHANGELOG
export const FETCH_CHANGELOG_START = 'FETCH_CHANGELOG_START'
export const FETCH_CHANGELOG_SUCCESS = 'FETCH_CHANGELOG_SUCCESS'
export const FETCH_CHANGELOG_ERROR = 'FETCH_CHANGELOG_ERROR'

export const CREATE_CHANGELOG_START = 'CREATE_CHANGELOG_START'
export const CREATE_CHANGELOG_SUCCESS = 'CREATE_CHANGELOG_SUCCESS'
export const CREATE_CHANGELOG_ERROR = 'CREATE_CHANGELOG_ERROR'
...
// BACKUPS
export const FETCH_BACKUPS_START = 'FETCH_BACKUPS_START'
export const FETCH_BACKUPS_SUCCESS = 'FETCH_BACKUPS_SUCCESS'
export const FETCH_BACKUPS_ERROR = 'FETCH_BACKUPS_ERROR'
